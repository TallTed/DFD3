...
| Process| <img src ="icons/rounded-rectangle.png" width=50 height=50> | A rounded rectangle.  Any running code which is under your control, including compiled, scripts, shell commands, SQL stored procedures, et cetera.
...
| Data flows| <img src ="icons/arrow.png" width=50 height=50> | An arrow. All the ways that processes can talk to data stores, external entities, or each other.
